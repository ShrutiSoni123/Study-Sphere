...
<nav>
    ...
    <div class="container">
      <div class="row justify-content-between">
        <div class="col-4" style="width: 35%; height: 450px; border: 1px goldenrod solid; border-radius: 50px; border-radius: 50px; text-align: center;">
          <h3>Advanced Python</h3><br><br>
        <div>
            <div>
                <p>Unit 1</p>
        ...
        <div class="col-4" style="width: 35%; border: 1px goldenrod solid; border-radius: 50px; border-radius: 50px; text-align: center; margin-left: 10%;">
          <h3>Advanced Web Tech</h3><br><br>
          <div>
              <div>
                  <p>Unit 1</p>
                  <button>view</button><button>download</button>
        ...
        <div class="col-4" style="width: 35%; border: 1px goldenrod solid; border-radius: 50px; text-align: center; margin-left: 10%; ">
          <h3 style="font-size: 32px;">Big Data with Analytics</h3><br><br>
          <div>
              <div>
                  <p>Unit 1</p>
                  <button>view</button><button>download</button>
