...
<nav>
    ...
    <div class="container-fluid" style="height: 450px; width: 400px; border: 1px goldenrod solid; border-radius: 50px; margin-left: 35%;">
        <h3>Maths</h3><br><br>
        <div>
            <div>
                <p>Unit 1</p>
                <button><a href="assest/notespdf/Math-U-1.pdf" style="text-decoration:none; color:black;">view</a></button><button onclick="downloadfile()" id="downloadButton">download</button>
            </div><br>
            <div>
                <p>Unit 2</p>
    ...
    var pdfPath = 'assest/notespdf/Math-U-1.pdf';
    var link = document.createElement('a');

    link.href = pdfPath;
    link.download = 'downloaded_file_Maths.pdf';
