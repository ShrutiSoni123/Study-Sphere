...
<nav>
    ...
    <div class="container-fluid" style="height: 450px; width: 400px; border: 1px goldenrod solid; margin-left: 35%;">
        <h3>Data Mining</h3><br><br>
        <div>
            <div>
                <p>Unit 1</p>
                <button><a href="assest/notespdf/DM-U-1.ppt" style="text-decoration:none; color:black;">view</a></button><button onclick="downloadfile()" id="downloadButton">download</button>
            </div><br>
            <div>
                <p>Unit 2</p>
    ...
    var pdfPath = 'assest/notespdf/DM-U-1.ppt';
    var link = document.createElement('a');

    link.href = pdfPath;
    link.download = 'downloaded_file_data_mining.pdf';
